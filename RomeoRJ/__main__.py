...
async def initiate_bot():
    ...
    console.print(
        "[bold green] 💞 RomeoRJ Userbot Started ✨\n"
    )
    try:
        await robot.send_message(
            LOG_GROUP_ID,
            "<b> 💞 RomeoRJ UserBot is Here ✨</b>",
        )
    ...
    if STRING_SESSION != "None":
        ...
        try:
            ...
            await client.join_chat("Romeo_op")
        except:
            pass
        console.print(f"├[red] UserBot Started as {ASSNAME}")
        console.print(f"├[green] ID :- {ASSID}")
        console.print(f"└[red] ✅ RomeoRJ UserBot Boot Complete 💯 ...")
        await idle()
        console.print(f"\n[red] Userbot Stopped")
...
async def start(_, message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/59b9eba6a5c7801d287d1.jpg",
        caption=f"""**━━━━━━━━━━━━━━━━━━━━━━━━
💥 Hᴇʟʟᴏ, I Aᴍ RomeoRJ
