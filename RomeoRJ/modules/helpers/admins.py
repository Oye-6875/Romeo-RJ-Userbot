...
from RomeoRJ.modules.helpers.interval import IntervalHelper
import RomeoRJ.modules.cache.admins

async def get_administrators(chat: Chat) -> List[User]:
    get = RomeoRJ.modules.cache.admins.get(chat.id)
    if get:
        return get
    else:
        ...
        RomeoRJ.modules.cache.admins.set(chat.id, to_set)
