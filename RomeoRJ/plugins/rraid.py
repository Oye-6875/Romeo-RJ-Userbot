...
from RomeoRJ.config import SUDO_USERS

from RomeoRJ.utilities.data import *
...
from RomeoRJ.utilities.mongo import kaalub_info, rkaal, runkaal
...
async def replyramd(client: Client, message: Message):
    ...
    if userz.id == mee.id:
        ...
        await Kaal.edit("`Jaa Na  Kahe Dimag Kha rha? Khudpe Raid kyu laga rha?`")
    ...
    if int(userz.id) in SUDO_USERS:
        ...
        await Kaal.edit("Abe chal that guy part of my devs.")
