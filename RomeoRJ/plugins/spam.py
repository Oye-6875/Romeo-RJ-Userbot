...
@Client.on_message(filters.command(["dspam", "delayspam"], ["/", ".", "!"]) & SUDOERS)
...
@Client.on_message(filters.command(commands, ["/", ".", "!"]) & SUDOERS)
...
.delayspam <seconds> <amount of spam> <text> - **Send spam text with a specified delay period!**
`.sspam` - **for stickers spam**
"""
