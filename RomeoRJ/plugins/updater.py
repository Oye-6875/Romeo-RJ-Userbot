...
from RomeoRJ.config import UPSTREAM_REPO, UPSTREAM_BRANCH, OWNER_ID
...
async def update_bot(_, message: Message):
    ...
    if update_avail:
        await msg.edit("**🔥 RomeoRJ UsᴇʀBᴏᴛ Uᴘᴅᴀᴛᴇᴅ\nTᴏ Lᴀᴛᴇsᴛ Vᴇʀsɪᴏɴ 🔥 ...\n\n💕 Rᴇsᴛᴀʀᴛɪɴɢ: Gᴇɴɪᴜs Usᴇʀ\nBᴏᴛ, Pʟᴇᴀsᴇ » Wᴀɪᴛ ✨ ...**")
        system("git pull -f && pip3 install -U -r requirements.txt")
        system("python3 -m RomeoRJ")
        return
    await msg.edit(f"**🔥 RomeoRJ UsᴇʀBᴏᴛ  Aʟʀᴇᴀᴅʏ\nUᴘᴅᴀᴛᴇᴅ Tᴏ Lᴀᴛᴇsᴛ 🔥 ...\n\n💕 Fᴏʀ Aɴʏ Qᴜᴇʀʏ › Cᴏɴᴛᴀᴄᴛ\nTᴏ » @AdityaHalder ✨ ...**")
...
**💬 Cᴏᴍᴍᴀɴᴅ :**
`.update` - __Tᴏ Uᴘᴅᴀᴛᴇ RomeoRJ UsᴇʀBᴏᴛ Tᴏ Lᴀᴛᴇsᴛ Vᴇʀsɪᴏɴ ...__
"""
