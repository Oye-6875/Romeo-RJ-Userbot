...
from RomeoRJ.modules.helpers.basics import edit_or_reply, get_text
...
@Client.on_message(filters.command(["emoji", "ej"], ["/", ".", "!"]) & SUDOERS)
...
@Client.on_message(filters.command(["cmoji", "cj"], ["/", ".", "!"]) & SUDOERS)
