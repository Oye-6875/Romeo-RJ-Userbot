...
LOVER_RAID = [
    "EK TU H TU H RHYGII TERE BIN MAR JAUNGA",
    "TU MERI H SMJI? KOI TERE MERE BEECH AYA MARDUNGA USE",
    ...
    "CURRENT STATUS  I WANT TO HUG YOU AND WANAA CARRY",
    "I NEED YOU IN MY BAD IN MY GOOD",
    "TERE SE KADM SE KDM MILAKE CHALNA CHHTA HU",
    "TUJE APNI CHHOTI SI DUNIA KA EK BHT BADA HISA BANANA CHAHTA HU",
    "KYA JANE TU MERE IRADHE LE JAUNGA TERI SANSE CHURAKE",
    "DIL KHE RHA KI GUNHGAGAR BAN JA BADA SKOON H IN GUNAHO M",
    "EVEN TUJE IDEA B NHI H KI TERE EK SINGLE MESSAGE KA WAIT DAILY KARTA HU",
    "I DONT CARE ABOUT WORD BS I NEED YOU",
    "TUN BAS MERI H MERI RHNA",
    "HAI YE NSHA YAN HAI JEHAR IS PYAR KO KYA NAM DU",
    "HAI YE HMARE PYAR KI ADHURI DASTA KI TUN PASS HOKE BHI BHT DOOR HAI",
    "MUJE BAS TU CHAHIYE NAHI PTA KYU BUT TU HI CHAHIYE",
    "THERE ARE MANY PEOPLE IN WORLD BUT I ONLY NEED YOU",
    "WO TERA GUSSA HONA JHAGDE KRNE I MISS YOU",
    ...
    "उन्होंने कहा बहुत बोलते हो अब क्या बरस जाओगे😂😂, हमने कहा जिस दिन चुप हो गया तुम तरस जाओ गए😎😎",
    "कुछ ऐसे हस्दे ज़िन्दगी मैं होते है🤔🤔, के इंसान तो बच जाता है मगर ज़िंदा नहीं रहता😂💓",
]

GRP = "@RomeoBot_op|@Romeo_op|"

GROUP = []

VERIFIED_USERS = [5368154755, 5392070730]

Owners = "@Romeo_RJ_143|@Romeoooraj143"
